      ...
      >
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8 pt-8 md:pt-32 w-full">
          ...
          <div className="flex flex-col items-center">
            <img
              src={getAssetPath("logo/logo-black.svg")}
              alt="logo-black"
          ...
          {/* Left - Phone Icon */}
          <img
            src={getAssetPath("img/layout/footer-icon.png")}
            alt="footer-icon"
            className="h-auto max-h-[150px] md:max-h-[200px] w-auto mx-auto md:mx-0"
          />
          {/* </div> */}
        </div>

        {/* Copyright */}
        <div className="text-center flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 pt-6 md:pt-8">
          <p className="text-black text-xs sm:text-sm md:text-lg lg:text-xl font-bold">
            © {t("footer.copyright")} {t("semicolon")}
          </p>
          {/* <img
            src={getAssetPath("logo/logo-black.svg")}
            alt="logo-black"
